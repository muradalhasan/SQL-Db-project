...
<html lang="en">
    ...
    <head>
        ...
        <title>Library Facility Booking System | Add Student</title>
...
<label for="studentname">Student ID <span class="text-danger">*</span></label>
<input type="text" class="form-control" placeholder="Student ID" required="true" name="studentregno" maxlength="8" pattern="\d{8}" title="Must be exactly 8 digits">
</div>
...
<input type="text" class="form-control" placeholder="Student Contact Number" required="true" name="studentcontactno" pattern="[0-9]{11}" maxlength="11" title="11 numeric characters only">
</div>
...
<div class="form-group">
<label for="studentname">Department<span class="text-danger">*</span></label>
<input type="text" class="form-control" placeholder="Department" required="true" name="qualification">
</div>
